...
| | 置き場所 | 読み手 | 内容 |
|---|---|---|---|
| **プロジェクト仕様・規約** | `document/` | 開発者 + AI | 概要・画面設計・データ構造・[開発規約](../document/06-conventions.md) など、人間も読むべき情報（目次は [document/README.md](../document/README.md)） |
| **タスク（issue）** | `issues/` | 開発者 + AI | 実装すべき機能を `NNN-feature.md` 形式で管理。新規作業はここから着手する issue を選ぶ。一覧は [issues/README.md](../issues/README.md) |
