...
| 2 | [03-durable-issue-orchestrator.md](03-durable-issue-orchestrator.md) | 単一の統括 session が issue DAG と worker を所有する永続・冪等オーケストレータ | 提案（実装 issue #182–#186） |
| 3 | [04-sccache-rust-builds.md](04-sccache-rust-builds.md) | sccache による Rust ビルド高速化の導入計画 | 提案（実装 issue #191） |
| 4 | [05-session-lifecycle.md](05-session-lifecycle.md) | session の作成・初期化・削除・失敗を `state.json` へ一元化する永続 lifecycle | 提案 |
