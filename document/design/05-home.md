...
- **没入（Attached）** — 埋め込みシェル / Agent が右ペインでライブ動作します。右ペインの上端には**タブストリップ**
  ...
  切り替え**、`Ctrl-G` で**没入のまま agent タブを追加**、`Ctrl-W` で**アクティブタブを閉じ**、`Ctrl-B` で**[サイドバーを開閉](#サイドバーの開閉ctrl-b)**します
...
`Ctrl-G` で**没入のまま agent タブを追加**、`Ctrl-W` で**アクティブタブを閉じ**、`Ctrl-B` で**[サイドバーを開閉](#サイドバーの開閉ctrl-b)**します（その分シェル / Agent 側の
