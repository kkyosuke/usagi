...
│   ├── terminal_manager.rs     # 埋め込みセッションの常駐保持＋監視スレッド＋入力待ち通知
...
└── presentation/               # CLI ルーティング・TUI・MCP
    ...
    └── tui/                    # ratatui ベースの TUI
        ...
        ├── home/               # ホーム画面（state / ui / event / command レジストリ / terminal_view / terminal_pane）
