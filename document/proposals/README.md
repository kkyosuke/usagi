...
| 18 | [18-goal-driven-work-run.md](18-goal-driven-work-run.md) | 目的を一度入力し、PR Ready または明示的な人間判断まで進める Work Run の画面フロー・状態・既存画面との境界 | goal-bound Director v1 は [03-tui.md](../03-tui.md) / [05-daemon.md](../05-daemon.md) へ畳み込み済み。SupervisorRun dashboard / verifier は提案 |
