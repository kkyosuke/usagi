...
| 17 | [17-multi-workspace-daemon.md](17-multi-workspace-daemon.md) | daemon の durable state を workspace 単位へ分割し、別 workspace の daemon を同時に動かして TUI の workspace 切り替えを refusal 無しにする設計 | 提案（実装 issue #708–#712） |
