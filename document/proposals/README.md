...
| 20 | [20-entry-resolution.md](20-entry-resolution.md) | 起動時に cwd / 直近 Recent から workspace を解決し、Welcome の Open / New / Recent を Home の `+ Open` overlay と Picker へ回収する設計 | 提案（未実装） |
