...
| 18 | [18-goal-driven-work-run.md](18-goal-driven-work-run.md) | 目的を一度入力し、PR Ready または明示的な人間判断まで進める Work Run の画面フロー・状態・既存画面との境界 | goal-bound Director v1、SupervisorRun の compact Active work / Director task projection、独立 artifact verifier は [03-tui.md](../03-tui.md) / [04-ipc.md](../04-ipc.md) / [05-daemon.md](../05-daemon.md) へ畳み込み済み。選択可能な複数 run 一覧、独立 Run Closeup、run-scoped defaults は提案 |
