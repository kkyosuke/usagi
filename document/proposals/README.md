...
| 2 | [02-ipc-id.md](02-ipc-id.md) | v2 daemon IPC の目標・権威・typed ID・fencing invariant | 提案（未実装） |
| 3 | [03-ipc-protocol.md](03-ipc-protocol.md) | envelope、handshake、stream、idempotency、bounded transport、error | 提案（未実装） |
| 4 | [04-daemon-api.md](04-daemon-api.md) | terminal/session command・event と socket/workspace/launch security | 提案（未実装） |
| 5 | [05-daemon-lifecycle.md](05-daemon-lifecycle.md) | active/draining restart、crash orphan、配置、実装 issue、test strategy | 提案（未実装） |
