...
| daemon crash / macOS 再起動 | runtime は identity_unknown。live tab を作らず、各 lineage は [interrupted tab](../03-tui.md#interrupted-agent-の-tab-投影と選択時-resume) として root / session を問わず別 tab で残り、明示 Resume だけが新 runtime を作る |
