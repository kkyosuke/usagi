...
や Claude / Codex の混在を別 item として保持する。
...
まだ owner object が構築されていなくても自 socket と返却エラーの temporary を回収する。process crash 後の stale
endpoint / temporary recovery は #515 が扱う。
