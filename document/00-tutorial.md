...
[design/05-home.md](design/05-home.md#モードと状態遷移切替在席没入) が正本です（切替へズームアウト＝在席・切替では `Ctrl-O`、没入では[キー方式](design/05-home.md#没入のキー操作attached--terminal--agent-実行中)に従い既定 `Ctrl-O o`、
