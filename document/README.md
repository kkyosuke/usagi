...
> 旧実装（v1）は独立したプロジェクトとして [../v1/](../v1/README.md) に退避してある。
> 本ディレクトリの機能・画面・データ仕様は v1 実装時点の記述を含み、v2 の実装が
> 進むのに合わせて対応するドキュメントを更新する。開発規約（[06-conventions.md](06-conventions.md)）は
> v1/v2 共通で引き続き有効である。
