...
| 027 | [agent-wait-notify](027-agent-wait-notify.md) ✅ | 埋め込みターミナルのバックグラウンド常駐と入力待ち通知（サイドバーマーカー＋デスクトップ通知） | tui | medium | 006, 026 |
...
3. **作業支援**: 005 ai / 006 terminal → 026 agent → 027 agent-wait-notify / 007 history / 012 diff
