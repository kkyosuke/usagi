...
fn terminal_body(action: usagi_core::infrastructure::ipc::TerminalAction) -> serde_json::Value {
    serde_json::to_value(usagi_core::infrastructure::ipc::DaemonRequest::Terminal {
        action,
        payload: json!(null),
    })
    .unwrap()
...
fn the_terminal_surface_separates_scope_queries_from_ref_addressed_io() {
    use usagi_core::infrastructure::ipc::TerminalAction as Action;
