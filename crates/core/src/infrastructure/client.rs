//! Surface-neutral daemon IPC client: connection, framing handshake, retry and
//! deadline policy.
//!
...
//!
//! The request / reply vocabulary this port carries lives in
//! [`crate::infrastructure::ipc::request`]; this module owns only how it travels.
...
use crate::infrastructure::ipc::{
    ...
    ProtocolVersion, ResponseOutcome, ServerHello, TERMINAL_CHECKPOINT_REVISION,
    TERMINAL_WIRE_GENERATION, TerminalInputReplayMode, TerminalSnapshotMode,
    client_advertised_capabilities, client_required_capabilities, is_workspace_mismatch,
    read_json_frame, terminal_input_replay_mode, terminal_snapshot_mode, write_json_frame,
};

#[cfg(test)]
use crate::domain::agent::{AgentProfileId, ProviderSessionId};
#[cfg(test)]
use crate::domain::id::{OperationId, SessionId};
#[cfg(test)]
use crate::domain::pr_inventory::PrInventory;
#[cfg(test)]
...
#[cfg(test)]
use crate::infrastructure::ipc::{RetryMode, SideEffect};
#[cfg(test)]
