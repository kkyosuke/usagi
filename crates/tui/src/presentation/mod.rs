...
fn render_controller_frame(
    ...
    if runtime.state().overlay() == Some(Overlay::QuitConfirmation) {
        return quit_modal::render_over(height, width, &frame, runtime.state().exit_choice());
    }
...
mod tests {
    ...
    use super::{
        ...
        render_home_snapshot, restore_open_panes, run as run_from_start,
    ...
    const RESIDENT_PORTS_PER_COMPOSITION: usize = 10;
