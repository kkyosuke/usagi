...
- fake monotonic clock により、5 分未満では表示せず、5 分到達時に eligible な Home だけで表示することを検証する。
...
- production screen graph test で自動表示、wake-up、click-to-Closeup、元 route への復帰を固定する。
