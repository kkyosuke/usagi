...
updated_at: 2026-08-06T20:40:03.222310+00:00
---
...
- daemon / PTY が遅くても、TUI は 1 frame 予算内で input・scroll・modal・quit を再び処理できる。
...
- #665〜#668 の実装と failure / boundary test がすべて `done`。
- burst output・hung terminal request・継続出力中のscroll・10,000行history上のclickを同時に含む実PTY回帰で、input / draw / quitのwall-clock boundを満たす。
